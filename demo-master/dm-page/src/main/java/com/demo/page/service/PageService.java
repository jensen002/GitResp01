package com.demo.page.service;

import com.demo.common.enums.ExceptionEnum;
import com.demo.common.exception.DmException;
import com.demo.item.pojo.*;
import com.demo.page.client.BrandClient;
import com.demo.page.client.CategoryClient;
import com.demo.page.client.GoodsClient;
import com.demo.page.client.SpecClient;
...
public class PageService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        if (!spu.getSaleable()) {
            throw new DmException(ExceptionEnum.GOODS_NOT_SALEABLE);
        }
