...
import com.demo.common.utils.NumberUtils;
import com.demo.item.pojo.*;
import com.demo.search.client.BrandClient;
import com.demo.search.client.CategoryClient;
import com.demo.search.client.GoodsClient;
import com.demo.search.client.SpecClient;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        if (brand == null) {
            throw new DmException(ExceptionEnum.BRAND_NOT_FOUND);
        }
