...
import com.demo.upload.config.UploadProperties;
import com.demo.upload.service.UploadService;
...
public class UploadServiceImpl implements UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        if (!prop.getAllowTypes().contains(contentType)) {
            throw new DmException(ExceptionEnum.INVALID_FILE_FORMAT);
        }
        ...
        try {
            ...
            throw new DmException(ExceptionEnum.UPLOAD_IMAGE_EXCEPTION);
        }
